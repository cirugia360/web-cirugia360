...
const LiposuccionSectionsPrimary = () => (
  <>
      ...
      <div className="container-premium px-6 py-8 md:px-12 lg:px-20">
        <ScrollReveal>
          <div className="text-center">
            <p className="subtitle-premium mb-5">Contorno corporal personalizado</p>
    ...
    <section className="bg-muted">
      <div className="container-premium section-padding">
        <ScrollReveal>
          <SectionHeading
            label="EL DESAFIO"
            title="Cuando el volumen localizado rompe la armonia del cuerpo"
            description="La liposuccion esta pensada para quienes sienten que hay zonas concretas de su contorno que no reflejan el esfuerzo que ponen en cuidarse."
          />
        </ScrollReveal>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          <ScrollReveal>
            <div>
              <SectionHeading
                label="LA SOLUCION"
                title="Liposuccion con enfoque anatomico y proporcionado"
                centered={false}
                description="No se trata solo de quitar grasa. Se trata de modelar el cuerpo con criterio, preservando transiciones naturales y una silueta coherente contigo."
              />
              <div className="mt-6 space-y-5 text-base leading-8 text-muted-foreground">
                <p>
                  La liposuccion ayuda a corregir grasa localizada en zonas donde los cambios de
                  estilo de vida no siempre logran el resultado deseado.
                </p>
                <p>
                  Cada plan se adapta a tu anatomia, a la zona que quieres mejorar y a la calidad
                  de tu piel para proyectar un contorno mas limpio y equilibrado.
                </p>
                <p>
                  El objetivo es que el cuerpo se vea mejor proporcionado, no operado ni
                  sobrecorregido.
                </p>
              </div>
          ...
          <ScrollReveal delay={0.1}>
            <div className="card-premium overflow-hidden rounded-lg border-border/70 bg-card">
              <img
                src={heroImage}
                alt="Evaluacion para liposuccion y modelacion corporal"
      ...
      <div className="container-premium section-padding">
        <ScrollReveal>
          <SectionHeading
            ...
            title="Un plan para la zona y el tipo de contorno que quieres mejorar"
            description="No toda liposuccion necesita la misma estrategia. Algunas personas buscan corregir una zona puntual y otras armonizar varias areas del contorno corporal."
          />
        </ScrollReveal>
...
export default LiposuccionSectionsPrimary;

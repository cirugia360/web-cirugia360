...
import { heroBadges, heroImage } from "@/pages/liposuccionData";

const LiposuccionHero = () => (
  <section id="inicio" className="relative flex min-h-screen items-center overflow-hidden scroll-mt-28 pt-24">
    <div className="absolute inset-0">
      <img
        src={heroImage}
        alt="Liposuccion para modelar el contorno corporal con resultado natural"
    ...
    <div className="relative container-premium section-padding pt-32">
      <ScrollReveal className="max-w-4xl">
        <p className="subtitle-premium mb-6 text-accent">Liposuccion en Chile</p>
        <h1 className="heading-display max-w-4xl text-background">
          Liposuccion para Modelar tu Contorno Corporal con Resultado Natural
        </h1>
        <p className="mt-6 max-w-2xl text-lg leading-8 text-[#F9FAFB99] md:text-xl">
          Cirugia de contorno corporal enfocada en grasa localizada, proporciones y armonia.
          Menos volumen donde sobra, mejor silueta donde importa.
        </p>
        <div className="mt-10">
...
export default LiposuccionHero;

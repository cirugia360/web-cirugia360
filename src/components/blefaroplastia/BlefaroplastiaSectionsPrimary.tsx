...
const BlefaroplastiaSectionsPrimary = () => (
  <>
      ...
      <div className="container-premium px-6 py-8 md:px-12 lg:px-20">
        <ScrollReveal>
          <div className="text-center">
            <p className="subtitle-premium mb-5">Cirugia de parpados especializada</p>
    ...
    <section className="bg-muted">
      <div className="container-premium section-padding">
        <ScrollReveal>
          <SectionHeading
            label="EL DESAFIO"
            title="Cuando el contorno de ojos envejece, toda la expresion cambia"
            description="La blefaroplastia esta pensada para quienes sienten que sus parpados hacen que su rostro se vea mas cansado, pesado o triste de lo que realmente se sienten."
          />
        </ScrollReveal>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          <ScrollReveal>
            <div>
              <SectionHeading
                label="LA SOLUCION"
                title="Blefaroplastia con enfoque preciso y natural"
                centered={false}
                description="La idea no es cambiar tus ojos. Es corregir exceso de piel o bolsas para que la mirada se vea mas limpia, descansada y armada con tu rostro."
              />
              <div className="mt-6 space-y-5 text-base leading-8 text-muted-foreground">
                <p>
                  La blefaroplastia corrige los cambios de los parpados superiores e inferiores
                  cuando la zona ocular empieza a proyectar fatiga, pesadez o envejecimiento.
                </p>
                <p>
                  Cada plan se define segun tu anatomia, el tipo de exceso de tejido y si la
                  prioridad es superior, inferior o una correccion combinada.
                </p>
                <p>
                  El objetivo es que te veas mejor descansado y mas fresco, sin perder expresion ni
                  naturalidad.
                </p>
              </div>
          ...
          <ScrollReveal delay={0.1}>
            <div className="card-premium overflow-hidden rounded-lg border-border/70 bg-card">
              <img
                src={heroImage}
                alt="Evaluacion para blefaroplastia y cirugia de parpados"
      ...
      <div className="container-premium section-padding">
        <ScrollReveal>
          <SectionHeading
            ...
            title="Un plan para el problema real de tus parpados"
            description="No todos los casos de blefaroplastia son iguales. Algunas personas necesitan tratar el exceso superior, otras las bolsas inferiores y otras una correccion integral."
          />
        </ScrollReveal>
    ...
    <ProcedureResultsPreviewSection procedureId="blefaroplastia" />
  </>
);

export default BlefaroplastiaSectionsPrimary;

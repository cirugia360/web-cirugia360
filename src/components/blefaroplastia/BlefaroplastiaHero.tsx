...
import { heroBadges, heroImage } from "@/pages/blefaroplastiaData";

const BlefaroplastiaHero = () => (
  <section id="inicio" className="relative flex min-h-screen items-center overflow-hidden scroll-mt-28 pt-24">
    <div className="absolute inset-0">
      <img
        src={heroImage}
        alt="Blefaroplastia para rejuvenecer la mirada con resultado natural"
    ...
    <div className="relative container-premium section-padding pt-32">
      <ScrollReveal className="max-w-4xl">
        <p className="subtitle-premium mb-6 text-accent">Blefaroplastia en Chile</p>
        <h1 className="heading-display max-w-4xl text-background">
          Blefaroplastia para una Mirada Mas Fresca, Descansada y Natural
        </h1>
        <p className="mt-6 max-w-2xl text-lg leading-8 text-[#F9FAFB99] md:text-xl">
          Cirugia de parpados superiores e inferiores para corregir exceso de piel, bolsas y
          mirada cansada, respetando por completo tu expresion.
        </p>
        <div className="mt-10">
...
export default BlefaroplastiaHero;

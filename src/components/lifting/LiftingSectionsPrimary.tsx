      ...
      <div className="container-premium px-6 py-8 md:px-12 lg:px-20">
        <ScrollReveal>
          <div className="text-center">
            <p className="subtitle-premium mb-5">Tecnica facial especializada</p>
    ...
    <section className="bg-muted">
      <div className="container-premium section-padding">
        <ScrollReveal>
          <SectionHeading
            label="EL DESAFIO"
            title="Cuando el rostro pierde soporte, ya no se trata solo de arrugas"
            description="El lifting facial esta pensado para quienes sienten que su cara luce mas cansada, caida o desdibujada que como realmente se sienten."
          />
        </ScrollReveal>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          <ScrollReveal>
            <div>
              <SectionHeading
                label="LA SOLUCION"
                title="Lifting facial con enfoque anatomico y natural"
                centered={false}
                description="No buscamos un rostro tirante. Buscamos reposicionar, redefinir y rejuvenecer con un resultado que se vea fresco, elegante y coherente contigo."
              />
              <div className="mt-6 space-y-5 text-base leading-8 text-muted-foreground">
                <p>
                  El lifting facial trabaja la flacidez desde su origen, reposicionando tejidos y
                  devolviendo soporte a rostro y cuello cuando los tratamientos temporales ya no son
                  suficientes.
                </p>
                <p>
                  Cada procedimiento se disena segun tu anatomia, tu grado de laxitud y la imagen
                  que quieres proyectar frente al espejo.
                </p>
                <p>
                  El objetivo es que te veas descansado, definido y mas fresco, no operado ni
                  exagerado.
                </p>
              </div>
          ...
          <ScrollReveal delay={0.1}>
            <div className="card-premium overflow-hidden rounded-lg border-border/70 bg-card">
              <img
                src={heroImage}
                alt="Evaluacion para lifting facial y rejuvenecimiento de cuello"
      ...
      <div className="container-premium section-padding">
        <ScrollReveal>
          <SectionHeading
            ...
            title="Un plan pensado para como envejece tu rostro"
            description="No todos los lifting faciales buscan lo mismo. Algunas personas necesitan devolver soporte al tercio medio y otras definir rostro y cuello de forma integral."
          />
        </ScrollReveal>
...
export default LiftingSectionsPrimary;
